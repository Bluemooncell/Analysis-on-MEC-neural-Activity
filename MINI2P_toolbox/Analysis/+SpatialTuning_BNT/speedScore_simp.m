...
%
function score = speedScore_simp(speed, firingRate, span, varargin)
    inp = inputParser;
    ...
    frWithNanSmoothed = smoothdata(frWithNan, 'gaussian', span);
    score = corr(speed(goodSpeed), frWithNanSmoothed(goodSpeed), 'rows', 'pairwise','type','Spearman');
